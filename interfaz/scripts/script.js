...
function obtenerSuma(val1, val2) {
    ...
    var url = 'http://0.0.0.0:3030/api/suma';
...
function obtenerResta(val1, val2) {
    ...
    var url = 'http://0.0.0.0:4040/api/resta';
...
function obtenerMultiplicacion(val1, val2) {
    ...
    var url = 'http://0.0.0.0:5050/api/multiplicacion';
...
function obtenerDivision(val1, val2) {
    ...
    var url = 'http://0.0.0.0:6060/api/division';
